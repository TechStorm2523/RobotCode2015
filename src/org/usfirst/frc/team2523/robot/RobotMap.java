...
//	public static Talon rearRightMotor = new Talon(rearRightPort);
	 ...
	 * PID CONTROL SYSTEMS
	 */
	public static PIDControl liftPIDControl = new PIDControl(0.02, 0.005, 0.1, -1.0, 1.0, 0.5);
	public static PIDControl drivePIDControl = new PIDControl(0.1, 0.005, 0.1, -1.0, 1.0, 0.5);
